...
public function getData()
{
    $query = DB::table('rkb')
        ->select(
            ...
            DB::raw('SUM(CASE WHEN rkb_items.status = "rejected" THEN 1 ELSE 0 END) as pending_count'),
            DB::raw('SUM(CASE WHEN rkb_items.status = "supply" THEN 1 ELSE 0 END) as pending_count'),
